        ...
        Tables: {
            profiles: {
                Row: {
                    ...
                    government_id_status: 'not_started' | 'pending' | 'verified' | 'rejected';
            ...
            requests: {
                Row: {
                    ...
                    start_date: string;
                    end_date: string;
                    status: 'pending_owner' | 'accepted' | 'payment_pending' | 'paid' | 'active' | 'returned' | 'completed' | 'cancelled' | 'declined' | 'overdue';
                    price_per_day: number;
                    days: number;
                    rental_fee: number;
                    deposit: number;
