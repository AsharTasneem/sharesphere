...
import type { User, Item, Request, Message, Notification, Review } from './types';
...
export function dbProfileToUser(profile: Tables<'profiles'>): User {
    return {
        ...
        verification: {
            ...
            governmentId: profile.government_id_status,
...
export function dbRequestToRequest(
    ...
    return {
        ...
        paymentMethod: request.payment_type && request.payment_last4
            ? {
