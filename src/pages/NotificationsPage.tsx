...
export default function NotificationsPage() {
  ...
  const groupedNotifications = {
    ...
    thisWeek: notifications.filter(n => {
      ...
      return new Date(n.createdAt) >= weekAgo && new Date(n.createdAt) < new Date().setHours(0, 0, 0, 0) - 86400000;
    }),
      ...
      {notifications.length === 0 ? (
        ...
        <div className="space-y-6">
          ...
          {groupedNotifications.thisWeek.length > 0 && (
            <div>
              <h2 className="text-sm font-semibold text-gray-500 uppercase mb-3">This Week</h2>
              <div className="space-y-2">
          ...
          {groupedNotifications.older.length > 0 && (
            <div>
              <h2 className="text-sm font-semibold text-gray-500 uppercase mb-3">Older</h2>
              <div className="space-y-2">
...
function NotificationItem({ notification, onMarkAsRead }: { notification: any; onMarkAsRead: () => void }) {
  return (
    <Card className={!notification.read ? 'bg-primary-50 border-primary-200' : ''}>
