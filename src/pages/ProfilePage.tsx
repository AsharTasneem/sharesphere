...
import { CheckBadgeIcon, StarIcon, EnvelopeIcon, PhoneIcon, IdentificationIcon, MapPinIcon, CalendarIcon, ChartBarIcon } from '@heroicons/react/24/solid';
import { StarIcon as StarOutlineIcon, PencilIcon, CameraIcon } from '@heroicons/react/24/outline';
            ...
            {editing ? (
              ...
              <>
                ...
                {user.bio ? (
                  ...
                  <p className="text-gray-400 italic mb-4">No bio yet. Add one to help others get to know you!</p>
                )}
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-gray-200">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-gray-900">{user.stats.rating.toFixed(1)}</span>
                <span className="text-gray-500 text-sm">({user.stats.reviewCount} reviews)</span>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <p className="text-2xl font-bold text-primary-600">{user.stats.totalBorrowed}</p>
                <p className="text-sm text-gray-600">Items Borrowed</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <p className="text-2xl font-bold text-primary-600">{user.stats.totalLent}</p>
            ...
            <div className="space-y-2 pt-2">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-semibold text-gray-900">{user.stats.responseTime || 'N/A'}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-600">Completion Rate</span>
                <span className="font-semibold text-gray-900">{user.stats.completionRate}%</span>
              </div>
            </div>
          </div>
        </Card>
      ...
      <Card>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-900">{user.location.city}, {user.location.state}, {user.location.country}</p>
          </div>
        </div>
      </Card>
    </div>
